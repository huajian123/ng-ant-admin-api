...
import filter.RepeatedlyRequestWrapper;
...
import static constant.Constants.REPEAT_SUBMIT_KEY;
...
public class SameUrlDataInterceptor extends RepeatSubmitInterceptor {
    ...
    public boolean isRepeatSubmit(HttpServletRequest request) {
        ...
        // 唯一值（没有消息头则使用请求地址）
        String submitKey = request.getHeader(TokenEnum.TOKEN_HEADER.getValue());
