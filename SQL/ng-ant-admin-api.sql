...
) ENGINE = InnoDB AUTO_INCREMENT = 145 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_permission` VALUES (49, '搜索列表', 'default:page-demo:list:search-list', 48, 1, '/default/page-demo/list/search-list', 'C', '1', '1', 0, NULL, 'table', '2022-05-10 08:45:15', '2022-05-10 10:31:12');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '超级管理员', '超级管理员111');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '$2a$10$1074VXUlfKCnylCu12At/u0abYvdeAGmA8rd0de2IuHfjjE/c/QzW', '2021-01-21 14:39:08', '2022-05-13 09:04:51', 1, 1, 13683758197, 'f13683758197@163.com', '2022-05-13 11:16:57', 3, '0375-0981', 15);
...
INSERT INTO `sys_user` VALUES (5, 'c', '$2a$10$PznM10iCZd0NejMDwFVFqOU3YdRNOUuOEzM7EFp3nDgQS9j0pdlA6', '2022-05-13 08:06:10', '2022-05-13 08:06:10', 1, 1, 13131313131, '345@adf.v', NULL, NULL, '02884449802', 30);
INSERT INTO `sys_user` VALUES (6, 'd', '$2a$10$/ec/0XTYG3Hjmzhj9.gXZujrt0ifGj9YnyAmQqnIuH1v7EbXxFVtG', '2022-05-13 08:06:23', '2022-05-13 08:06:23', 1, 1, 13131313131, '345@adf.v', NULL, NULL, '02884449802', 17);
INSERT INTO `sys_user` VALUES (7, 'e', '$2a$10$CmLklqxpu2ECUGrvAGKCtOfd7l53DFo9id2TlkXQu6NrJKR9e/24O', '2022-05-13 08:06:35', '2022-05-13 08:06:35', 1, 1, 13131313131, '345@adf.v', NULL, NULL, '02884449802', 15);
INSERT INTO `sys_user` VALUES (8, 'f', '$2a$10$R/BaOl.8QR0IBv2/6dm45.gOZ9SmGC4wLV8oxxOBkVhpBT3t4yLOO', '2022-05-13 08:06:45', '2022-05-13 08:06:45', 1, 1, 13131313131, '345@adf.v', NULL, NULL, '02884449802', 15);
INSERT INTO `sys_user` VALUES (9, 'g', '$2a$10$rDCxOxtiwfguqnUp.Pd8au0/aBGWosv3fsptmr4XG5yfLh9FFWB3O', '2022-05-13 08:06:54', '2022-05-13 08:06:54', 1, 1, 13131313131, '345@adf.v', NULL, NULL, '02884449802', 15);
INSERT INTO `sys_user` VALUES (10, 'h', '$2a$10$5zpgqOl2eMCoM0LS//dwJOiC5h8iCNzqQlxSP1xJ1OkaQOR0T1mQu', '2022-05-13 08:09:03', '2022-05-13 08:43:29', 1, 0, 13131313131, '345@adf.v', NULL, NULL, '02884449802', 17);
